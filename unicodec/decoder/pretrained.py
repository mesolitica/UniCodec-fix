...
class Unicodec(nn.Module):
    ...
    def codes_to_features(self, codes: torch.Tensor) -> torch.Tensor:
        ...
        features = self.feature_extractor.encodec.quantizer.vq.embedding(embeddings_idxs)[0]
        features = self.feature_extractor.encodec.quantizer.vq.embedding_proj(features)
